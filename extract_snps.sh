...
finalsnplist=${sumstats_path}candidate_SC_wdup.txt

# candidate_SI_wdup.txt candidate_CPD_wdup.txt  candidate_AI_wdup.txt

#====== Extract HRS =======
genout_path=/Users/Mingzhou/Desktop/AD_Grant/smk_dem_MR/data/genome/
genoex=${genout_path}${geno_file}.indsig.SC
